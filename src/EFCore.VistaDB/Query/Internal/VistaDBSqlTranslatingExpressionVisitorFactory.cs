...
/// </summary>
public class VistaDBSqlTranslatingExpressionVisitorFactory : IRelationalSqlTranslatingExpressionVisitorFactory
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public VistaDBSqlTranslatingExpressionVisitorFactory(
    ...
    public virtual RelationalSqlTranslatingExpressionVisitor Create(
        ...
        => new VistaDBSqlTranslatingExpressionVisitor(
            Dependencies,

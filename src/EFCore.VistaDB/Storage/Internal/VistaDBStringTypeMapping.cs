...
public class VistaDBStringTypeMapping : StringTypeMapping
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static new VistaDBStringTypeMapping Default { get; } = new();
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static VistaDBStringTypeMapping UnicodeDefault { get; } = new(
    ...
    protected override RelationalTypeMapping Clone(RelationalTypeMappingParameters parameters)
    {
        ...
        return new VistaDBStringTypeMapping(parameters);
    }

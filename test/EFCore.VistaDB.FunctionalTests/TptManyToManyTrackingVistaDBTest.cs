...
public class TptManyToManyTrackingVistaDBTest(TptManyToManyTrackingVistaDBTest.TptManyToManyTrackingVistaDBFixture fixture)
    : ManyToManyTrackingVistaDBTestBase<TptManyToManyTrackingVistaDBTest.TptManyToManyTrackingVistaDBFixture>(fixture)
{
    public class TptManyToManyTrackingVistaDBFixture : ManyToManyTrackingVistaDBFixtureBase
    {
        protected override string StoreName
            => "TptManyToManyTrackingVistaDBTest";

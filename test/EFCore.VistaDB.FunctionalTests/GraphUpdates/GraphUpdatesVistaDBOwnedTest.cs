...
public class GraphUpdatesVistaDBOwnedTest(GraphUpdatesVistaDBOwnedTest.VistaDBFixture fixture)
    : GraphUpdatesVistaDBTestBase<GraphUpdatesVistaDBOwnedTest.VistaDBFixture>(fixture)
{
    // No owned types

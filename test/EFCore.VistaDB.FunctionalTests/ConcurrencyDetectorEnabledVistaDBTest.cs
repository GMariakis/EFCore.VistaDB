...
public class ConcurrencyDetectorEnabledVistaDBTest : ConcurrencyDetectorEnabledRelationalTestBase<
    ConcurrencyDetectorEnabledVistaDBTest.ConcurrencyDetectorVistaDBFixture>
{
    public ConcurrencyDetectorEnabledVistaDBTest(ConcurrencyDetectorVistaDBFixture fixture)
        : base(fixture)

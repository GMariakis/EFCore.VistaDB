...
public class ManyToManyTrackingGeneratedKeysVistaDBTest(
    ManyToManyTrackingGeneratedKeysVistaDBTest.ManyToManyTrackingGeneratedKeysVistaDBFixture fixture)
    : ManyToManyTrackingVistaDBTestBase<ManyToManyTrackingGeneratedKeysVistaDBTest.ManyToManyTrackingGeneratedKeysVistaDBFixture>(
        fixture)
{
    public class ManyToManyTrackingGeneratedKeysVistaDBFixture : ManyToManyTrackingVistaDBFixtureBase
    {

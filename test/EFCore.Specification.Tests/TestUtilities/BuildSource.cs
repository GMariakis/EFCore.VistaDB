    ...
    public async Task<Assembly> BuildInMemoryWithWithAnalyzersAsync()
    {
        var compilation = CSharpCompilation
            .Create(
                ...
                CreateOptions());
            // Standalone: UninitializedDbSetDiagnosticSuppressor lives only in the analyzer-side DLL,
            // not in lib/ — skip attaching it here. Roslyn analyzer coverage tested in the EF Core monorepo.

...
public class VistaDBMigrationsAnnotationProviderTest
{
    private readonly VistaDBAnnotationProvider _annotations = new(new RelationalAnnotationProviderDependencies());
    ...
    public void For_property_handles_identity_annotations()
    {
        ...
        var identity = Assert.Single(migrationAnnotations, a => a.Name == VistaDBAnnotationNames.Identity);

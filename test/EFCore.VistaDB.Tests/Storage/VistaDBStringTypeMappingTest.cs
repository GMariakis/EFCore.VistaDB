...
public class VistaDBStringTypeMappingTest
{
    ...
    {
        var mapping = new VistaDBStringTypeMapping("varchar(max)");
    ...
    {
        var mapping = new VistaDBStringTypeMapping("nvarchar(max)", unicode: true);
        Assert.Equal(expected, mapping.GenerateProviderValueSqlLiteral(value));
    }
}

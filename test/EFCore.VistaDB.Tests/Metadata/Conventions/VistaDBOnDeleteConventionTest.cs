...
public class VistaDBOnDeleteConventionTest
{
    ...
    public void Convention_does_not_assume_skip_navigations_have_non_null_FK()
    {
        ...
        // VistaDBOnDeleteConvention (ported from SqlServerOnDeleteConvention) detects the self-referencing
        // skip navigation across a shared join table and converts one FK's Cascade -> ClientCascade to
        // prevent multiple-cascade-path issues. Matches SqlServer's behavior on the same model.
        Assert.Equal(
    ...
    public class SkippyDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder.UseVistaDB("Data Source=Dummy.vdb6");
    }
